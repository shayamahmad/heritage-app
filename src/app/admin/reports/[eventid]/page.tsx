...
async function EventReportPage({ params }: Props) {
    ...
    eventBookings.forEach((booking) => {
        ticketTypesAndTheirRevenue[booking.ticketType] = {
            ticketsSold: ticketTypesAndTheirRevenue[booking.ticketsCount]
                ? ticketTypesAndTheirRevenue[booking.ticketsCount] + booking.ticketsCount
                : booking.ticketsCount,

            revenue: ticketTypesAndTheirRevenue[booking.totalAmount]
                ? ticketTypesAndTheirRevenue[booking.totalAmount] + booking.totalAmount
                : booking.totalAmount,
        };
    });
