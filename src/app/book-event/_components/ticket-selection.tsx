...
const stripePromise = loadStripe('pk_test_51NaD7GSJ9bw3ilLsxIOpYTsI4x12aPG3gqdKzJ3nNq6aW6awrTrDCrj6719TLvpx1mjUi3w5SNMFr6drhQtLyJyO00lOIVU1Ix');
...
function TicketSelection({ event, eventBookings }: TicketSelectionProps) {
    ...
    return (
        <div className="mt-7">
            <div>
                <h1 className="text-xl font-semibold text-gray-700 mt-2">Select Ticket Type</h1>
              ...
              `}
                        ...
                        >
                            ...
                            <h1 className="text-gray-600 text-sm flex justify-between">${ticketType.price}
            ...
            <div className="mt-7">
                <h1 className="text-xl font-semibold text-gray-700">Select Tickets Count</h1>
                {/* This line is givinbg spaces between the boxes */}
                <div className="flex mt-2">
                    {[...Array(10)].map((_, index) => (
                        <div className={`bg-gray-100 border h-12 w-14 rounded-sm flex justify-center items-center cursor-pointer
                            ${ticketCount === index + 1
                                ? "border-blue-800"
                                : "border-gray-200 "
                            }
